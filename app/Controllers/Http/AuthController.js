                ...
                switch (user.rol) {
                    ...
                    case "grey":
                        ...
                        if(request.ip() == "192.168.1.1"){
                            ...
                            const urltemp = UrlSigner.temporarySign('https://api.rojuescenario5tienda.xyz/confirmacion', .1, {Hfrlmi:user.id});
                            return response.status(200).json({
                                status: true,
                    ...
                    case "black":
                        console.log("BLACK")
                            ...
                            const urltemp1 = UrlSigner.temporarySign('https://api.rojuescenario5tienda.xyz/confirmacion', .1, {Hfrlmi:user.id});
                            return response.status(200).json({
                                status: true,
                                message: "Confirme su email",
                                rol:"black",
